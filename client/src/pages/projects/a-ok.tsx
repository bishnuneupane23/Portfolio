...
export default function AOKCaseStudy() {
  useEffect(() => {
    document.title = "Case Study: a-OK | Bishnu Neupane - QA Lead";
  }, []);

  const goals = [
    "Defect leakage ≤10% per release",
    "Redemption API p95 ≤ 600ms @ 10,000 CCU",
    "Automation pass ≥90% on critical redemption paths",
              ...
              <Card>
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground text-lg" data-testid="text-problem-description">
                    unreliable redemption flow; API instability under load; regression escapes.
                  </p>
                </CardContent>
              </Card>
